...
public class FeaturedArtist {
     ...
     * @param url
     */
    public FeaturedArtist(String apiPath, String headerImageUrl, Integer id, String imageUrl, Boolean isMemeVerified, Boolean isVerified, String name, String url, Integer iq) {
        super();
